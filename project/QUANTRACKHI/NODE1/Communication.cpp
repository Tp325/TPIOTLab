      ...
      if (doc1.containsKey("CM")) {
        if (doc1["CM"].as<String>() != "ACK") {
          ...
          if (doc1["CM"].as<String>() == "CH") {
            ...
            doc1["WS"] = enviromentParameter.windSpeed;
            doc1["WD"] = enviromentParameter.windDirection;
            doc1["ATem"] = enviromentParameter.airTemperature;
            doc1["AHum"] = enviromentParameter.airHumidity;
            doc1["APr"] = enviromentParameter.airPressure;
            doc1["AVPD"] = enviromentParameter.vaporPressureDeficit;
            doc1["Ra"] = enviromentParameter.rain;
            doc1["WTem"] = enviromentParameter.waterTem;
